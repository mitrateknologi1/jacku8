            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-head-row">
                        <div class="card-title">Data Jabatan Fungsional</div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modal-tambah-title">Tambah Jabatan Fungsional</h5>
                    ...
                    <div class="modal-body">
                        @component('dashboard.components.formElements.input',
                            [
                                ...
                                'placeholder' => 'Tambah Jabatan Fungsional',
                                'name' => 'nama',
                                'required' => true,
                            ])
                        @endcomponent
...
@push('script')
    <script>
        ...
        $('#btn-tambah').click(function() {
            ...
            $('#modal-tambah-title').html('Tambah Jabatan Fungsional');
        })
        ...
        $(document).on('click', '#btn-edit', function() {
            ...
            $.ajax({
                url: "{{ url('master-data/jabatan-fungsional') }}" + '/' + id + '/edit',
                type: "GET",
                data: {
                    id: id
                },
                success: function(response) {
                    aksiTambah = 'ubah';
                    $('#modal-tambah').modal('show');
                    $('#modal-tambah-title').html('Ubah Jabatan Fungsional');
        ...
        $('#form-tambah').submit(function(e) {
            ...
            if (aksiTambah == 'tambah') {
                $.ajax({
                    url: "{{ url('master-data/jabatan-fungsional') }}",
                    type: 'POST',
                    data: $(this).serialize(),
                    success: function(response) {
                ...
                $.ajax({
                    url: "{{ url('master-data/jabatan-fungsional') }}" + '/' + idEdit,
                    type: 'PUT',
                    data: $(this).serialize(),
                    success: function(response) {
                        if (response.status == 'success') {
        ...
        $(document).on('click', '#btn-delete', function() {
            ...
            swal({
                ...
                if (Delete) {
                    $.ajax({
                        url: "{{ url('master-data/jabatan-fungsional') }}" + '/' + id,
                        type: 'DELETE',
                        data: {
                            '_token': '{{ csrf_token() }}'
                        },
    ...
    <script>
        $(document).ready(function() {
            $('#master-jabatan-fungsional').addClass('active');
        })
