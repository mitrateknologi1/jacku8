            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modal-tambah-title">Tambah Kategori</h5>
...
@push('script')
    <script>
        ...
        $('#btn-tambah').click(function() {
            ...
            $('#modal-tambah-title').html('Tambah Kategori');
        })
        ...
        $(document).on('click', '#btn-edit', function() {
            ...
            $.ajax({
                url: "{{ url('berita/kategori') }}" + '/' + id + '/edit',
                type: "GET",
                data: {
                    id: id
                },
                success: function(response) {
                    aksiTambah = 'ubah';
                    $('#modal-tambah').modal('show');
                    $('#modal-tambah-title').html('Ubah Kategori');
        ...
        $('#form-tambah').submit(function(e) {
            ...
            if (aksiTambah == 'tambah') {
                ...
                $.ajax({
                    url: "{{ url('berita/kategori') }}" + '/' + idEdit,
                    type: 'PUT',
                    data: $(this).serialize(),
                    success: function(response) {
                        if (response.status == 'success') {
    ...
    <script>
        $(document).ready(function() {
            $('#berita-kategori').addClass('active');
        })
