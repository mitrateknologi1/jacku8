...
@push('script')
    <script>
        ...
        $(document).on('click', '#btn-edit', function() {
            ...
            $.ajax({
                url: "{{ url('divisi-kurikulum/arsip') }}" + '/' + id + '/edit',
                type: "GET",
                data: {
                    id: id
                },
        ...
        $('#form-tambah').submit(function(e) {
            ...
            if (aksiTambah == 'tambah') {
                $.ajax({
                    url: "{{ url('divisi-kurikulum/arsip') }}",
                    type: 'POST',
                    data: formData,
                    cache: false,
                    contentType: false,
                ...
                $.ajax({
                    url: "{{ url('divisi-kurikulum/arsip') }}" + '/' + idEdit,
                    type: 'POST',
                    data: formData,
                    cache: false,
                    contentType: false,
        ...
        $(document).on('click', '#btn-delete', function() {
            ...
            swal({
                ...
                if (Delete) {
                    $.ajax({
                        url: "{{ url('divisi-kurikulum/arsip') }}" + '/' + id,
                        type: 'DELETE',
                        data: {
                            '_token': '{{ csrf_token() }}'
                        },
    ...
    <script>
        $(document).ready(function() {
            $('#kurikulum-arsip').addClass('active');
        })
