            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modal-tambah-title">Tambah Monitoring</h5>
                        ...
                        <div class="col">
                            @component('dashboard.components.formElements.input',
                                [
                                    'id' => 'tanggal_upload',
                                    'type' => 'text',
                                    'label' => 'Tanggal Monitoring (Hari-Bulan-Tahun, Contoh : 01-12-2022)',
...
@push('script')
    <script>
        ...
        $('#btn-tambah').click(function() {
            ...
            $('#modal-tambah-title').html('Tambah Monitoring');
        ...
        $(document).on('click', '#btn-edit', function() {
            ...
            $.ajax({
                url: "{{ url('divisi-kurikulum/monitoring') }}" + '/' + id + '/edit',
                type: "GET",
                data: {
                    id: id
                },
                success: function(response) {
                    aksiTambah = 'ubah';
                    $('#modal-tambah').modal('show');
                    $('#modal-tambah-title').html('Ubah Monitoring');
        ...
        $('#form-tambah').submit(function(e) {
            ...
            if (aksiTambah == 'tambah') {
                $.ajax({
                    url: "{{ url('divisi-kurikulum/monitoring') }}",
                    type: 'POST',
                    data: formData,
                    cache: false,
                    contentType: false,
                ...
                $.ajax({
                    url: "{{ url('divisi-kurikulum/monitoring') }}" + '/' + idEdit,
                    type: 'POST',
                    data: formData,
                    cache: false,
                    contentType: false,
        ...
        $(document).on('click', '#btn-delete', function() {
            ...
            swal({
                ...
                if (Delete) {
                    $.ajax({
                        url: "{{ url('divisi-kurikulum/monitoring') }}" + '/' + id,
                        type: 'DELETE',
                        data: {
                            '_token': '{{ csrf_token() }}'
                        },
    ...
    <script>
        $(document).ready(function() {
            $('#kurikulum-monitoring').addClass('active');
        })
