            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modal-tambah-title">Tambah Penelitian</h5>
...
@push('script')
    <script>
        ...
        $('#btn-tambah').click(function() {
            ...
            $('#modal-tambah-title').html('Tambah Penelitian');
        ...
        $(document).on('click', '#btn-edit', function() {
            ...
            $.ajax({
                url: "{{ url('divisi-penelitian/penelitian') }}" + '/' + id + '/edit',
                type: "GET",
                data: {
                    id: id
                },
                success: function(response) {
                    aksiTambah = 'ubah';
                    $('#modal-tambah').modal('show');
                    $('#modal-tambah-title').html('Ubah Penelitian');
                    ...
                    idSkema = response.skema_penelitian_id;
                    idSumberDana = response.sumber_dana_id;
                    getSkema();
                    setTimeout(
                        function() {
                            $('#skema').val(response.skema_penelitian_id).trigger('change');
                        }, 500
                    );
                    getSumberDana();
                    setTimeout(
        ...
        $('#form-tambah').submit(function(e) {
            ...
            if (aksiTambah == 'tambah') {
                $.ajax({
                    url: "{{ url('divisi-penelitian/penelitian') }}",
                    type: 'POST',
                    data: formData,
                    cache: false,
                    contentType: false,
                ...
                $.ajax({
                    url: "{{ url('divisi-penelitian/penelitian') }}" + '/' + idEdit,
                    type: 'POST',
                    data: formData,
                    cache: false,
                    contentType: false,
        ...
        $(document).on('click', '#btn-delete', function() {
            ...
            swal({
                ...
                if (Delete) {
                    $.ajax({
                        url: "{{ url('divisi-penelitian/penelitian') }}" + '/' + id,
                        type: 'DELETE',
                        data: {
                            '_token': '{{ csrf_token() }}'
                        },
    ...
    <script>
        $(document).ready(function() {
            $('#penelitian-penelitian').addClass('active');
        })
