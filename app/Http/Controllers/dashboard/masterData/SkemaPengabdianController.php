...
class SkemaPengabdianController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $data = SkemaPengabdian::orderBy('created_at', 'asc')->get();
        ...
        return view('dashboard.pages.masterData.skemaPengabdian.index');
    }
    ...
    public function store(Request $request)
    {
        $validator = Validator::make(
            $request->all(),
            [
                'nama' => ['required', Rule::unique('skema_pengabdian')->withoutTrashed()],
            ],
            [
        ...
        $skemaPengabdian = new SkemaPengabdian();
        $skemaPengabdian->nama = $request->nama;
        $skemaPengabdian->save();
     ...
     *
     * @param  \App\Models\SkemaPengabdian  $skemaPengabdian
     * @return \Illuminate\Http\Response
     */
    ...
    {
        return response()->json($skemaPengabdian);
    }
    ...
    public function update(Request $request, SkemaPengabdian $skemaPengabdian)
    {
        $validator = Validator::make(
            $request->all(),
            [
                'nama' => ['required', Rule::unique('skema_pengabdian')->ignore($skemaPengabdian->id)->withoutTrashed()],
            ],
            [
                'nama.required' => 'Nama skema pengabdian tidak boleh kosong',
                'nama.unique' => 'Nama skema pengabdian sudah ada',
