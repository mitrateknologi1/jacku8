...
class ArsipPenelitianController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('dashboard.pages.divisiPenelitian.arsip.index', compact(['listProdi']));
    }
    ...
    public function store(Request $request)
    {
        ...
        $request->file_upload->storeAs('divisiPenelitian/arsip', $file_upload);

        $arsip = new ArsipPenelitian();
     ...
     *
     * @param  \App\Models\ArsipPenelitian  $arsipPenelitian
     * @return \Illuminate\Http\Response
     */
    public function show(ArsipPenelitian $arsipPenelitian)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(ArsipPenelitian $arsipPenelitian)
    {
        return response()->json($arsipPenelitian);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, ArsipPenelitian $arsipPenelitian)
    {
        $validator = Validator::make(
            $request->all(),
            [
        ...
        if ($request->file_upload) {
            if (Storage::exists('divisiPenelitian/arsip/' . $arsipPenelitian->file)) {
                Storage::delete('divisiPenelitian/arsip/' . $arsipPenelitian->file);
            }

            $file_upload = time() . '.' . $request->file_upload->extension();
            $request->file_upload->storeAs('divisiPenelitian/arsip', $file_upload);
            $arsipPenelitian->file = $file_upload;
        }

        $arsipPenelitian->nama = $request->nama;
        $arsipPenelitian->jenis_dokumen = $request->jenis_dokumen;
        $arsipPenelitian->tanggal_upload = Carbon::parse($request->tanggal_upload)->format('Y-m-d');
        $arsipPenelitian->save();
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(ArsipPenelitian $arsipPenelitian)
    {
        $arsipPenelitian->delete();
